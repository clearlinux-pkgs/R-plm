...
Version  : 2.0.0
Release  : 24
URL      : https://cran.r-project.org/src/contrib/plm_2.0-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plm_2.0-0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557847231
