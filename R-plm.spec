...
Source0  : https://cran.r-project.org/src/contrib/plm_2.4-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632235336
...
/usr/lib64/R/library/plm/tests/test_pdata.frame_pseriesfy.Rout
