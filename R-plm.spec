...
Version  : 2.2.1
Release  : 33
URL      : https://cran.r-project.org/src/contrib/plm_2.2-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plm_2.2-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581994729
