...
Version  : 2.4.0
Release  : 42
URL      : https://cran.r-project.org/src/contrib/plm_2.4-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plm_2.4-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611428591
