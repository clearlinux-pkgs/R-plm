...
Version  : 2.0.1
Release  : 25
URL      : https://cran.r-project.org/src/contrib/plm_2.0-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plm_2.0-1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558647938
